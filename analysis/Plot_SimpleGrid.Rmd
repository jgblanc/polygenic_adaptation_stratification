...
```{r}
df <- fread("~/polygenic_adaptation_stratification/code/plot/SimpleGrid_seed_deme_T100_pgs.txt")
...
```{r}
df <- fread("~/polygenic_adaptation_stratification/code/plot/SimpleGrid_seed_deme_T100.txt") 
