...
df <- plyr::ldply(reps, agg_data, file_path='../output/Simulate_Phenotypes/4PopSplit/', file_name='/C1/h2-0.8/genos-gwas_common.gvalue.sscore')
...
```{r}
df <- plyr::ldply(reps, agg_data, file_path='../output/Simulate_Phenotypes/4PopSplit/', file_name="/C1/h2-0.8/env-2/genos-gwas_common.phenos.txt")
...
```{r}
genos <- plyr::ldply(reps, agg_data, file_path='../output/Simulate_Phenotypes/4PopSplit/', file_name='/C1/h2-0.8/genos-gwas_common.gvalue.sscore')
phenos <- plyr::ldply(reps, agg_data, file_path='../output/Simulate_Phenotypes/4PopSplit/', file_name="/C1/h2-0.8/env-2/genos-gwas_common.phenos.txt")
...
prs <- plyr::ldply(reps, agg_test, file_path='../output/PRS/4PopSplit/', file_name_prs='/C1/h2-0.8/env-2/genos-test_common.nc.sscore', file_name_gv='/C1/h2-0.8/genos-test_common.true.sscore')
