...
Fts <- c(0.01, 0.001, 0.0001, 0)
#col<-terrain.colors(length(Fts))
col <- c("#00A600" ,"#E6E600","#EAB64E", "#EEB99F", "#F2F2F2")
for (i in 1:length(Fts)) {
  curve(compute_fpr(x, Ft = Fts[i]), from = 10, to = 500000,add=i!=1, col=col[i], log = "x", xlab = "Test panel sample size", ylab = "False positive rate", lwd=2)
}
