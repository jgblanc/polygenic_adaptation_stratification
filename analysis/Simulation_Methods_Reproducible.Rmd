...
nc$diff <- as.numeric(nc$diff)
pl5 <- plot_data(nc, "darkgreen") + ggtitle("C1 - Pop ID") + theme(plot.title = element_text(hjust = 0.5, size = 12))+ geom_point(data = df_true_C1, aes(x = diff, y = fp_strat), col = "red", shape = 8, size = 2.5)
