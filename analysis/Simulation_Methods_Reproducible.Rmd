...
```{r}
fp <- fread("../code/Make_Plots/SimpleGrid_fp_C_PS.txt.gz")
...
df1 <- df %>% filter(type %in% c("PC10", "PC50", "PC100", "PC200", "PC300", "PC500")) 
df1$type <- factor(df1$type, levels = c("PC10", "PC50", "PC100", "PC200", "PC300", "PC500"))
...
egg::ggarrange(pl2, pl1, nrow=1, widths = c(0.4, 0.6))
```
