...
envs <- c("env-0.0", "env-1.0", "env-2.0", "env-3.0", "env-4.0", "env-5.0","env-6.0","env-7.0", "env-8.0", "env-9.0", "env-10.0")
cases <- c("C1")
...
fwrite(df, "4PopSplit_T100_h23.txt", row.names=F,quote=F,sep="\t", col.names = T)
