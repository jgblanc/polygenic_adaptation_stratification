...
--wait-for-files /project2/jjberg/jgblanc/polygenic_adaptation_stratification/.snakemake/tmp.vtt6rzbc output/Simulate_Genotypes/4PopSplit/V1/C2/genos-test_common.psam output/Simulate_Phenotypes/4PopSplit/V1/C2/genos-gwas_common.effects.txt output/Simulate_Genotypes/4PopSplit/V1/C2/genos-test_common.afreq --latency-wait 5 \
 --attempt 1 --force-use-threads \
--wrapper-prefix https://github.com/snakemake/snakemake-wrappers/raw/ \
  -p --allowed-rules calc_true_gv --nocolor --notemp --no-hooks --nolock \
--mode 2  && touch /project2/jjberg/jgblanc/polygenic_adaptation_stratification/.snakemake/tmp.vtt6rzbc/4.jobfinished || (touch /project2/jjberg/jgblanc/polygenic_adaptation_stratification/.snakemake/tmp.vtt6rzbc/4.jobfailed; exit 1)
