...
--wait-for-files /project2/jjberg/jgblanc/polygenic_adaptation_stratification/.snakemake/tmp.vtt6rzbc output/Simulate_Genotypes/4PopSplit/V1/C2/genos-test.psam output/Simulate_Genotypes/4PopSplit/V1/C2/genos-test.pvar output/Simulate_Genotypes/4PopSplit/V1/C2/genos-test.pgen --latency-wait 5 \
 --attempt 1 --force-use-threads \
--wrapper-prefix https://github.com/snakemake/snakemake-wrappers/raw/ \
  -p --allowed-rules get_variant_freq --nocolor --notemp --no-hooks --nolock \
--mode 2  && touch /project2/jjberg/jgblanc/polygenic_adaptation_stratification/.snakemake/tmp.vtt6rzbc/25.jobfinished || (touch /project2/jjberg/jgblanc/polygenic_adaptation_stratification/.snakemake/tmp.vtt6rzbc/25.jobfailed; exit 1)
