...
--wait-for-files /project2/jjberg/jgblanc/polygenic_adaptation_stratification/.snakemake/tmp.2bnf0mpv output/Simulate_Genotypes/4PopSplit/V1/C1/genos-test_common.psam output/PRS/4PopSplit/V1/C1/genos-gwas_common.c.betas output/PRS/4PopSplit/V1/C1/genos-gwas_common.c.p.betas output/PRS/4PopSplit/V1/C1/genos-gwas_common.nc.betas output/Simulate_Genotypes/4PopSplit/V1/C1/genos-test_common.afreq --latency-wait 5 \
 --attempt 1 --force-use-threads \
--wrapper-prefix https://github.com/snakemake/snakemake-wrappers/raw/ \
  -p --allowed-rules calc_prs --nocolor --notemp --no-hooks --nolock \
--mode 2  && touch /project2/jjberg/jgblanc/polygenic_adaptation_stratification/.snakemake/tmp.2bnf0mpv/1.jobfinished || (touch /project2/jjberg/jgblanc/polygenic_adaptation_stratification/.snakemake/tmp.2bnf0mpv/1.jobfailed; exit 1)
