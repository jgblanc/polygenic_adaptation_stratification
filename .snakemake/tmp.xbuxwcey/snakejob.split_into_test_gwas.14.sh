...
--wait-for-files /project2/jjberg/jgblanc/polygenic_adaptation_stratification/.snakemake/tmp.xbuxwcey output/Simulate_Genotypes/4PopSplit/V1/C1/ids.gwas output/Simulate_Genotypes/4PopSplit/V1/C1/ids.test output/Simulate_Genotypes/4PopSplit/V1/genos.psam output/Simulate_Genotypes/4PopSplit/V1/genos.pvar output/Simulate_Genotypes/4PopSplit/V1/genos.pgen --latency-wait 5 \
 --attempt 1 --force-use-threads \
--wrapper-prefix https://github.com/snakemake/snakemake-wrappers/raw/ \
  -p --allowed-rules split_into_test_gwas --nocolor --notemp --no-hooks --nolock \
--mode 2  && touch /project2/jjberg/jgblanc/polygenic_adaptation_stratification/.snakemake/tmp.xbuxwcey/14.jobfinished || (touch /project2/jjberg/jgblanc/polygenic_adaptation_stratification/.snakemake/tmp.xbuxwcey/14.jobfailed; exit 1)
